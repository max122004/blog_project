...
from article.models import Article, Comment, Category, Like, Share
from article.permission import ArticleCreatePermission, ArticleDetailPermission, IsAuthorOrReadOnly
from article.serializer import ArticleListSerializer, ArticleDetailSerializer, ArticleCreateSerializer, \
    ArticleUpdateSerializer, ArticleDestroySerializer, CategoryListSerializer, CommentCreateSerializer, \
    CommentUpdateSerializer, CommentDestroySerializer, LikeSerializer, ShareSerializer
...
# вот это необходимо разобрать завтра
...
# выводит все лайкнутые статьи у человека
